...
class WellknownTextRecord implements Record {
  ...
  String toString() {
    ...
    return 'WellknownTextRecord{identifier: $identifier, languageCode: $languageCode, text: $text}';
  }
}
...
class WellknownUriRecord implements Record {
  ...
  @override
  String toString() {
    return 'WellknownUriRecord{identifier: $identifier, uri: $uri}';
  }
}
...
class MimeRecord implements Record {
  ...
  @override
  String toString() {
    return 'MimeRecord{identifier: $identifier, type: $type, data: $data}';
  }
}
...
class AbsoluteUriRecord implements Record {
  ...
  @override
  String toString() {
    return 'AbsoluteUriRecord{identifier: $identifier, uriType: $uriType, payload: $payload}';
  }
}
...
class ExternalRecord implements Record {
  ...
  @override
  String toString() {
    return 'ExternalRecord{identifier: $identifier, domain: $domain, type: $type, data: $data}';
  }
}
